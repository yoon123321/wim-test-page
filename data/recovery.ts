...
export const RECOVERY_CONTENT = {
  ...
  passes: {
    ...
    trials: [
      {
        name: "크라이오테라피",
        desc: "-140℃ 초저온 냉각 케어로 지친 몸을 깨우고 빠른 컨디션 회복을 돕습니다.",
        duration: "3분",
      ...
      {
        name: "인프라레드 사우나",
        desc: "몸속까지 따뜻하게 데워 쌓인 긴장을 풀고 개운한 컨디션을 만들어줍니다.",
        duration: undefined,
      ...
      {
        name: "인프라레드 캡슐",
        desc: "몸을 따뜻하게 데워 땀 배출과 전신 이완을 돕는 관리입니다.",
        duration: undefined,
      ...
      {
        name: "고압산소챔버",
        desc: "고농도 산소를 편안하게 공급해 지친 몸의 활력과 회복을 돕습니다.",
        duration: undefined,
      ...
      {
        name: "에어프레셔",
        desc: "공기압으로 하체를 부드럽게 압박해 붓고 무거운 다리를 가볍게 풀어줍니다.",
        duration: undefined,
        originalPrice: "50,000원",
        discountPercent: "40%",
        price: "30,000원",
    ...
    allInOneEyebrow: "ALL-IN-ONE PACKAGE",
    allInOneTitle: "올인원 패키지",
    allInOnePackages: [
      {
        name: "다이어트 올인원 패키지",
        duration: "1시간",
        ...
        discountPercent: "42%",
        salePrice: "130,000원",
        composition: ["크라이오테라피", "고압산소챔버", "인프라레드 사우나"],
        description: [
          "크라이오테라피부터 고압산소챔버, 인프라레드 사우나까지 세 가지 프리미엄 웰니스 프로그램을 한 번에 경험할 수 있는 올인원 패키지입니다.",
          "지친 몸의 컨디션 관리와 다이어트 루틴을 위한 프리미엄 올인원 케어를 만나보세요.",
        ],
      },
      {
        name: "붓기 집중 케어 패키지",
        ...
        discountPercent: "44%",
        salePrice: "70,000원",
        composition: ["인프라레드", "에어프레셔"],
        description: [
          "오래 앉아 있어 몸이 무겁게 느껴지는 날, 운동이나 시술 후 컨디션 관리가 필요한 날, 평소 얼굴과 몸의 붓기가 고민되는 날을 위한 프리미엄 웰니스 패키지입니다.",
          "두 가지 프로그램을 한 번에 경험하며 무겁고 지친 일상에 가벼운 리커버리 루틴을 더해보세요.",
        ],
      },
    ],
  },
