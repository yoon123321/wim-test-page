...
export const PAGE_SINGLE_CONTENT = {
  hero: {
    ...
    title: " 왜 나는 예전처럼 빠지지 않을까요?",
    description: '"적게 먹으면 빠진다." "운동하면 빠진다." "참으면 빠진다." 정말 그럴까요? 반복되는 감량과 체중 증가 속에서 식욕, 근육량, 활동량, 생활습관은 계속 변합니다. 그래서 지금의 나에게 예전의 다이어트가 통하지 않을 수 있습니다.',
