...
export const PAGE_SINGLE_CONTENT = {
  hero: {
    ...
    title: "체지방 낮추고, 삶의 질 높이다",
    description: "Diet & Longevity — 리커버리의 새로운 지평",
  ...
  devices: {
    ...
    items: [
      ...
      { kicker: "DEVICE 02 · INFRARED", name: "인프라레드 캡슐", desc: "깊은 곳부터 데우는 30분. 누워만 있어도 땀이 시작됩니다.", tags: ["딥 히트", "순환"], photo: ["인프라레드 캡슐 실사진", "(누워서 발한 장면)"], flip: true },
      { kicker: "DEVICE 03 · OXYGEN", name: "옥시챔버", desc: "평소보다 진한 산소를 몸 구석까지. 무거운 날의 리셋 버튼.", tags: ["산소 충전", "피로 리셋"], photo: ["옥시챔버 실사진", "(고압산소 캡슐 내부)"] },
      { kicker: "DEVICE 04 · AIR PRESSURE", name: "에어프레셔", desc: "다리 끝부터 밀어 올리는 압력의 파도. 하루 종일 서 있던 다리를 위해.", tags: ["림프 순환", "다리 부종"], photo: ["에어프레셔 실사진", "(다리 공압 슈트)"], flip: true },
      { kicker: "DEVICE 05 · FASCIA", name: "근막 리커버리", desc: "뭉친 곳을 정확히 찾아 풀어냅니다. 관리 후 첫 기지개가 다릅니다.", tags: ["근막 이완", "결림"], photo: ["근막리커버리 실사진", "(관리 장면)"] },
    ],
  },
  combinations: {
