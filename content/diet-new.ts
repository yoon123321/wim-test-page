 ...
 * 헤더 스위치에서 "개선안"을 고르면 보이는 /wireframe-1 페이지의 문구는 전부 이 파일에서 수정합니다.
 */
...
export const DIET_NEW_COPY = {
  ...
  problem: {
    ...
    quizLabel: "12문항으로 내 유형을 확인해 보세요",
    quizNote: "· 정식 검사는 WIM-I · WIM-Scale로 따로 진행합니다",
    quizButton: "1분 유형 검사 (무료)",
  },
  diff: {
  ...
  cta: {
    ...
    primaryButton: "1분 다이어트 유형 검사 (무료)",
    secondaryButton: "프로그램 문의",
  },
  survey: {
    kicker: "1분 다이어트 유형 검사 — 간편 버전",
    note: "정식 검사는 WIM-I(기질) · WIM-Scale(생활 습관)로, 문항 수가 훨씬 많고 상담 때 따로 진행합니다.",
    question: "해당되는 것을 모두 골라 주세요",
    submitLabel: "결과 보기",
    resultKicker: "RESULT",
    consultButton: "정식 검사 상담 신청",
    retryButton: "다시 하기",
  },
  footer: {
    brandKo: "윔센터",
...
export const DIET_SURVEY = [
  "저녁이나 밤에 유독 많이 먹습니다",
  "스트레스를 받으면 먹는 것으로 풀게 됩니다",
  "배가 고프지 않아도 습관처럼 먹습니다",
  "식사 속도가 빠른 편입니다",
  "단 음식이나 밀가루를 끊기 어렵습니다",
  "식단을 지켜도 체중이 잘 줄지 않습니다",
  "아침을 거르는 날이 많습니다",
  "회식이나 외식이 주 2회 이상입니다",
  "야식이나 간식을 자주 먹습니다",
  "하루 수면이 6시간 미만입니다",
  "운동을 규칙적으로 하지 못합니다",
  "몇 번 빼봤지만 매번 요요가 왔습니다",
] as const;

export const DIET_SURVEY_RESULTS = [
  { max: 3, title: "생활은 잡혀 있는 편입니다", body: "큰 흐름은 무너지지 않았습니다. 남은 것은 방향입니다. 어디를 조금 조정하면 되는지 검사로 확인하면 짧게 끝납니다." },
  { max: 7, title: "무너지는 지점이 몇 군데 보입니다", body: "의지가 아니라 특정 상황에서 반복적으로 흔들리는 패턴입니다. 그 지점을 찾으면 참지 않고도 바꿀 수 있습니다." },
  { max: 12, title: "원인부터 확인해야 하는 상태입니다", body: "식습관·수면·활동량이 함께 얽혀 있습니다. 하나씩 바꾸기보다 검사로 원인을 좁힌 뒤 순서를 정하는 편이 빠릅니다." },
] as const;
